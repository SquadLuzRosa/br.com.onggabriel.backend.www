...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "testmonial.Depoiment": "fas fa-comments",
        "testmonial.Function": "fas fa-user-tag",
        "management": "fas fa-cogs",
        "management.ManagementMedia": "fas fa-photo-video",
        "management.HomePresentationSection": "fas fa-home",
        "management.HomeDepoimentCard": "fas fa-id-card",
    },
...
SPECTACULAR_SETTINGS = {
    ...
    'EXTENSIONS': [
        ...
        'authentication.extensions.SimpleJWTScheme',
    ],
}
